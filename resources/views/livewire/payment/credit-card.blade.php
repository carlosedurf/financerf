<div class="max-w-7xl mx-auto py-15 px-4 mt-10" x-data="creditCard()" x-init="PagSeguroDirectPayment.setSessionId('{{$sessionId}}')">
    ...
    <form action="" name="creditCard" class="w-full max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full py-4 px-3 mb-6">
                <button @click.prevent="cardToken" type="submit" class="flex-shrink-0 bg-green-500 hover:bg-green-700 border-green-500 hover:border-green-700 text-sm border-4 text-white py-1 px-2 rounded">Realizar Assinatura</button>
            </p>
    ...
    <script>
        ...
        /*
            - precisa recuperar o token do cartão
            - envia o token e o sender hash para o componente php
        */
        function creditCard(){
