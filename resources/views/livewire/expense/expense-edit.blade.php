<div class="max-w-7xl mx-auto py-15 px-4 mt-10">
    ...
    <form action="" wire:submit.prevent="updateExpense" class="w-full max-w-7xl mx-auto">
        ...
        <div class="w-full py-4 px-3 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 bg-blue-500 hover:bg-blue-700 border-blue-500 hover:border-blue-700 text-sm border-4 text-white py-1 px-2 rounded">Atualizar Registro</button>
        </div>
    </form>
</div>
